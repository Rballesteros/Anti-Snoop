...
if(currentURL.search('facebook') != -1){
	var facebookNav = document.getElementById('userNavigationLabel');
	if(facebookNav != undefined){
		facebookNav.click();
		setTimeout(function(){
			var facebookLogout = document.getElementsByClassName('_w0d')[0];
...
if(currentURL.search('github') != -1){
	logoutElement = document.getElementsByClassName('dropdown-item dropdown-signout')[0];
	if(logoutElement !== undefined){
		logoutElement.click();	
